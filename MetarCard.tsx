  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (metarResponse.ok) {
        ...
        } else if (metarData && !Array.isArray(metarData)) {
          setMetar(metarData);
        }
      } else {
        console.error('METAR Response Error:', metarResponse.status, metarResponse.statusText);
      }
      ...
      if (airportResponse.ok) {
        ...
        } else if (airportData && !Array.isArray(airportData)) {
          setAirport(airportData);
        }
      } else {
        console.error('Airport Response Error:', airportResponse.status, airportResponse.statusText);
      }
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-card-foreground">
                {metar.visib === 'P6' || metar.visib === 6 ? '>6 SM' : `${metar.visib} SM`}
              </p>
            </div>
          </div>
